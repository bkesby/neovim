...
local on_attach = function(_, bufnr)
   ...
   buf_set_keymap("n", rc.declaration, "<cmd>lua vim.lsp.buf.declaration()<CR>",
                  opts)
   buf_set_keymap("n", rc.definition, "<cmd>lua vim.lsp.buf.definition()<CR>",
                  opts)
   buf_set_keymap("n", rc.hover, "<cmd>lua vim.lsp.buf.hover()<CR>", opts)
   buf_set_keymap("n", rc.implementation,
                  "<cmd>lua vim.lsp.buf.implementation()<CR>", opts)
   buf_set_keymap("n", rc.signature_help,
                  "<cmd>lua vim.lsp.buf.signature_help()<CR>", opts)
   buf_set_keymap("n", rc.add_workspace_folder,
                  "<cmd>lua vim.lsp.buf.add_workspace_folder()<CR>", opts)
   buf_set_keymap("n", rc.remove_workspace_folder,
                  "<cmd>lua vim.lsp.buf.remove_workspace_folder()<CR>", opts)
   buf_set_keymap("n", rc.list_workspace_folders,
                  "<cmd>lua print(vim.inspect(vim.lsp.buf.list_workspace_folders()))<CR>",
                  opts)
   buf_set_keymap("n", rc.type_definition,
                  "<cmd>lua vim.lsp.buf.type_definition()<CR>", opts)
   buf_set_keymap("n", rc.rename, "<cmd>lua vim.lsp.buf.rename()<CR>", opts)
   buf_set_keymap("n", rc.code_action, "<cmd>lua vim.lsp.buf.code_action()<CR>",
                  opts)
   buf_set_keymap("n", rc.references, "<cmd>lua vim.lsp.buf.references()<CR>",
                  opts)
   ...
   buf_set_keymap("n", rc.formatting, "<cmd>lua vim.lsp.buf.formatting()<CR>",
                  opts)
